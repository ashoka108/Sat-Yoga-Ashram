...
<form name="adminForm" class="ui form" method="post" action="<?php echo JRoute::_('index.php?option=com_surveyforce&view=insert_survey&tmpl=component'); ?>"> 
<h2><?php echo JText::_('COM_SF_SELECT_SURVEY_TO_INSERT');?>:</h2>
<div id="j-main-container" class="span12">
    <div id="filter-bar" class="btn-toolbar">
            <div class="field filter-search btn-group pull-left">
            ...
            <div class="field btn-group pull-left">
                    <button type="submit" class="ui button btn hasTooltip" title="<?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?>"><i class="search icon"></i></button>
                    <button type="button" class="ui button btn hasTooltip" title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>" onclick="document.id('filter_search').value='';this.form.submit();"><i class="remove icon"></i></button>
            </div>
        </div>
...
<div style="float:right; clear:both;">
    <br />
    <button onclick="insert();" class="ui green button"><?php echo JText::_('COM_SF_INSERT_TAG');?></button>
</div>