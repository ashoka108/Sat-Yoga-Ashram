...
<div class="item-page<?php echo $this->cparams->get('pageclass_sfx', null);?>">
	<?php if ($this->cparams->get('show_page_heading', 1)) : ?>
			<h3 class="ui teal header"> <?php echo $this->escape($this->cparams->get('page_heading', $this->menuTitle)); ?> </h3>
	<?php endif;?>
</div>
	
<form action="<?php echo JRoute::_('index.php?option=com_jchat&task=form.saveEntity&format=json');?>" method="post" name="activation_form" id="activation_form" dir="ltr" class="ui form">
       	<div class="jchat_formfields_container">
       		<?php if($this->cparams->get('show_email', true)):?>
       		<div class="two fields">
       		<?php endif;?>
			 <div class="field">
		   		<label class="add-on"><?php echo JText::_('COM_JCHAT_NICKNAME');?></label>
			...
			<?php if($this->cparams->get('show_email', true)):?>
				 <div class="field">
			   		<label class="add-on"><?php echo JText::_('COM_JCHAT_EMAIL');?></label>
			...
			<?php if($this->cparams->get('show_description', true)):?>
				 <div class="field">
			   		<label class="add-on"><?php echo JText::_('COM_JCHAT_DESCRIPTION');?></label>
			...
			<?php if($this->cparams->get('show_skypeid', false)):?>
				 <div class="field">
			   		<label class="add-on"><?php echo JText::_('COM_JCHAT_SKYPEID');?></label>
			...
			<?php if($this->cparams->get('show_antispam', false)):?>
				 <div class="field">
			   		<label class="add-on"><?php echo JText::_('COM_JCHAT_SPAM_VALIDATION');?></label>
			   		<?php 
			   			$operand1 = rand(0, 10);
			   			$operand2 = rand(0, 10);
			   		?>
		...
		<input type="submit" class="jchat_button ui button" value="<?php echo JText::_('COM_JCHAT_START_CHAT');?>"/>
