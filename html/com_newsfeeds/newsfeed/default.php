...
else
{
	...
	<div class="img-intro-<?php echo htmlspecialchars($imgfloat, ENT_COMPAT, 'UTF-8'); ?>"> <img class="ui fluid image"
		<?php if ($images->image_first_caption):
			echo ' title="' . htmlspecialchars($images->image_first_caption, ENT_COMPAT, 'UTF-8') . '"';
		endif; ?>
