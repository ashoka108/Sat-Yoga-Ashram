...
<?php if ($params->get('dropdown', 1) && !$params->get('dropdownimage', 0)) : ?>
	...
	<div class="ui floating dropdown labeled search icon button">
		...
		<span class="text"><?php echo JText::_( 'selectlang' ); ?></span>
		<div class="menu" onchange="document.location.replace(this.value);">
	<?php foreach ($list as $language) : ?>
		<div class="item" dir=<?php echo $language->rtl ? '"rtl"' : '"ltr"'; ?> data-value="<?php echo $language->link; ?>" <?php echo $language->active ? 'selected="selected"' : ''; ?>>
		<?php echo $language->title_native; ?></div>
	<?php endforeach; ?>
	</div>
	</form>
