...
class JPagination
{
	...
	protected function _list_render($list)
	{
		...
		$html = '<div class="ui borderless pagination menu" style="display: inline-block;">';
	...
	protected function _item_active(JPaginationObject $item)
	{
		...
		if ($this->app->isAdmin())
		{
			return '<a class="item"' . $title . ' href="#" onclick="document.adminForm.' . $this->prefix
			. 'limitstart.value=' . ($item->base > 0 ? $item->base : '0') . '; Joomla.submitform();return false;">' . $item->text . '</a>';
		}
		else
		{
			return '<a' . $title . ' href="' . $item->link . '" class="' . $class . 'item">' . $item->text . '</a>';
		}
	}
	...
	protected function _item_inactive(JPaginationObject $item)
	{
		if ($this->app->isAdmin())
		{
			return '<div class="disabled pagenav item">' . $item->text . '</div>';
		}
		else
		{
			return '<div class="pagenav active item">' . $item->text . '</div>';
		}
	}
