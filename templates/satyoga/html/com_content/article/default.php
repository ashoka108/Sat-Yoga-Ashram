	...
	<?php if ($params->get('show_title') || $params->get('show_author')) : ?>
        ...
        <?php else : ?>
            <?php if ($useDefList) : ?>
                ...
                <div id="pop-print" class="print icon">
                    <?php echo JHtml::_('icon.print_screen', $this->item, $params); ?>
                </div>
            <?php endif; ?>
        <?php endif; ?>
		<h2 class="ui dividing teal header" itemprop="name">
		...
		<?php if ($this->item->state == 0) : ?>
			<div class="ui negative message">
				<i class="close icon"></i><?php echo JText::_('JUNPUBLISHED'); ?>
            </div>
        <?php endif; ?>

			<?php if (strtotime($this->item->publish_up) > strtotime(JFactory::getDate())) : ?>
				<div class="ui negative message">
					<i class="close icon"></i> class="label label-warning"><?php echo JText::_('JNOTPUBLISHEDYET'); ?></div>
				<?php endif; ?>
				<?php if ((strtotime($this->item->publish_down) < strtotime(JFactory::getDate())) && $this->item->publish_down != JFactory::getDbo()->getNullDate()) : ?>
					<div class="ui negative message">
						<i class="close icon"></i><?php echo JText::_('JEXPIRED'); ?></div>
					<?php endif; ?>
				<?php endif; ?>
