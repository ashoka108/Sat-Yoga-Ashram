...
$layoutData = (object) array(
	'class' => 'ui green fabrik_filter_submit button',
	'name' => 'filter',
	'label' => FabrikHelperHTML::icon('filter icon', FText::_('COM_FABRIK_GO'))
);
?>
...
<tr class="fabrikFilterContainer">
	<?php foreach ($this->headings as $key => $heading) :
		...
		if (array_key_exists($key, $this->filters)) :
			...
			?>
			<div class="listfilter<?php  echo $required; ?> left floated">
