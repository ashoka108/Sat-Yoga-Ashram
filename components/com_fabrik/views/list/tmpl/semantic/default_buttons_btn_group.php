...
<div class="btn-group">
	...
	<?php if ($this->showAdd) {?>
		<a class="addbutton btn addRecord" href="<?php echo $this->addRecordLink;?>">
			<?php echo FabrikHelperHTML::icon('plus iconv_strpos(haystack, needle)', $this->addLabel);?>
		</a>
	<?php }?>
	...
	<?php if ($this->showCSV) {?>
		<a href="#" class="btn csvExportButton">
			<?php echo FabrikHelperHTML::icon('upload icon', FText::_('COM_FABRIK_EXPORT_TO_CSV')); ?>
		</a>
	<?php }?>
	...
	<?php if ($this->showCSVImport) {?>
		<a href="<?php echo $this->csvImportLink;?>" class="btn csvImportButton">
			<?php echo FabrikHelperHTML::icon('download icon', FText::_('COM_FABRIK_IMPORT_FROM_CSV')); ?>
		</a>
	<?php }?>

	<?php if ($this->showRSS) {?>
		<a href="<?php echo $this->rssLink;?>" class="ui button feedButton">
			<?php echo FabrikHelperHTML::image('feed.png', 'list', $this->tmpl);?>
			<?php echo FText::_('COM_FABRIK_SUBSCRIBE_RSS');?>
		</a>
	<?php }
	if ($this->showPDF) {?>
			<a href="<?php echo $this->pdfLink;?>" class="ui button  pdfButton">
				<?php echo FabrikHelperHTML::icon('file pdf icon', FText::_('COM_FABRIK_PDF')); ?>
			</a>
	<?php }?>
