...
if ($this->params->get('show_page_heading')) :
	echo '<h1 class="ui teal dividing header">' . $this->params->get('page_heading') . '</h1>';
endif;

if ($this->showTitle == 1) : ?>
	<h1 class="ui teal dividing header"><?php echo $this->table->label;?></h1>
...
?>
<form class="ui form fabrikForm form-search" action="<?php echo $this->table->action;?>" method="post" id="<?php echo $this->formid;?>" name="fabrikList">
...
endforeach;
?>
	<table class="ui celled striped table <?php echo $this->list->class;?>" id="list_<?php echo $this->table->renderid;?>" >
